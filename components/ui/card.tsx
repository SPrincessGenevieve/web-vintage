...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-primary-gray-400 border-primary-brown/30 text-card-foreground flex flex-col gap-6 rounded-xl border py-2 shadow-sm",
        className
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-2 rounded-2xl bg-primary-gray-400", className)}
      {...props}
    />
  )
}
