...
import { SpecialVolumeT, WineResultDetailT } from "@/lib/types";
...
export default function SpecialVolumeChart({
  ...
  const results_single = data.results[0];
  const ParentWineName = data.wine_details.name;
  const bottle_size = results_single.bottle_size;
  const case_size = data.wine_details.default_case_size;
  const bottle =
    bottle_size === "0750"
      ? 75
      : bottle_size === "1500"
  ...
  return (
    <div className="p-4 flex flex-col gap-4">
      <Label variant="h1">
        {ParentWineName}, {results_single.vintage}, {case_size}x{bottle}cl
      </Label>
